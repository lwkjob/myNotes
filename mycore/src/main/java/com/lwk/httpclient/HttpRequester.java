...
public class HttpRequester {
    ...
    public static HttpResponse sendPost(String requestUrl, Map<String, String> headersMap,String content) throws Exception {
     ...
     //   logger.info("requestParam:"+ LoggerTools.printLogger(content));
      ...
      //  logger.info("responseJson:status =" + httpResponse.getStatus() +" "+ LoggerTools.printLogger(httpResponse.getHtml()));
        return httpResponse;
    }
