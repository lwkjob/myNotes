...
public class ASMTestMain {
	...
	public static void main(String []args) 
		...
		//在字节码增强前记录一个Class
		Class <?>beforeASMClass = TEST_CLASS_LOADER.loadClass("com.lwk.jvm.classloader.aop.ForASMTestClass");
		
		//我们重新装载修改后的类
		TEST_CLASS_LOADER.defineClassByByteArray("com.lwk.jvm.classloader.aop.ForASMTestClass", asmChangeClassCall());
		Class <?>afterASMClass = TEST_CLASS_LOADER.loadClass("com.lwk.jvm.classloader.aop.ForASMTestClass");
	...
	private static byte[] asmChangeClassCall() throws IOException {
		ClassReader classReader = new ClassReader("com.lwk.jvm.classloader.aop.ForASMTestClass");
