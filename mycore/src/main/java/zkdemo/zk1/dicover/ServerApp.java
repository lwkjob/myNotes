...
public class ServerApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ServiceInstance<InstanceDetails> instance1 = ServiceInstance.<InstanceDetails>builder()
                ...
                .payload(new InstanceDetails(UUID.randomUUID().toString(),"192.168.1.100",12345,"Test.Service3"))
        ...
        ServiceInstance<InstanceDetails> instance2 = ServiceInstance.<InstanceDetails>builder()
                ...
                .payload(new InstanceDetails(UUID.randomUUID().toString(),"192.168.1.100",12345,"Test.Service4"))
                .uriSpec(new UriSpec("{scheme}://{address}:{port}"))
                .build();
