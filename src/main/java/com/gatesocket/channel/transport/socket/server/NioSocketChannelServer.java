...
import com.gatesocket.channelprocessor.BocmPosProcessor;
 ...
 */
public class NioSocketChannelServer extends AbstractChannelServer {
...
//			config.setKeepAlive(true);
			...
			handler.setChannelProcessor(new BocmPosProcessor());  //已经更改
